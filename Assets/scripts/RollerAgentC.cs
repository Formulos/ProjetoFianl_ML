...
public class RollerAgentC : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(prey1.transform.localPosition);
        sensor.AddObservation(prey1.GetComponent<Rigidbody>().velocity.x);
        sensor.AddObservation(prey1.GetComponent<Rigidbody>().velocity.z);

        sensor.AddObservation(prey2.transform.localPosition);
        sensor.AddObservation(prey2.GetComponent<Rigidbody>().velocity.x);
        sensor.AddObservation(prey2.GetComponent<Rigidbody>().velocity.z);

        sensor.AddObservation(prey3.transform.localPosition);
        sensor.AddObservation(prey3.GetComponent<Rigidbody>().velocity.x);
        sensor.AddObservation(prey3.GetComponent<Rigidbody>().velocity.z);
...
/*             hunger--;
        ...
        if (collision.gameObject.CompareTag("agentH"))
        {
            collision.gameObject.GetComponent<RollerAgent>().eaten();
            AddReward(1f);
